...
if __name__ == "__main__":
    ...
    parser.add_argument("--gen_base_dir", type=str, default='output/5th_lightningdit_xl_vavae_f16d32_gmm30_use_weight_finetune/lightningdit-xl-1-ckpt-0024000-euler-20/class_0')
    # parser.add_argument("--gen_base_dir", type=str, default='/mnt/HDD2/dataset/lsun/church_outdoor_val/church') # a6000
    parser.add_argument("--real_base_dir", type=str, default="/mnt/HDD_raid1/lsun/church_outdoor_train/church")
